...
export default function Register() {
  ...
  return (
    ...
    >
      <div className="flex bg-gradient-to-r from-blue-100 via-white to-blue-100 rounded-3xl shadow-lg w-[670px] h-[395px] overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div className="relative">
              ...
              >
                <i
                  className={`ri-${
                    showConfirmPassword ? "eye-line" : "eye-off-line"
                  } text-xl`}
                ></i>
              </button>
            </div>
